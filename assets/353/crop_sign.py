...
cv2.waitKey(0)
cv2.imwrite('sign1/img1.jpg', img)
...
cv2.waitKey(0)
cv2.imwrite('sign1/img2.jpg', blue_mask)
...
cv2.waitKey(0)
cv2.imwrite('sign1/img5.jpg', contour_img)
...
cv2.drawContours(approx_contour_img, [approx_polygon], -1, (0, 0, 255), 3)
cv2.imshow('image', approx_contour_img)
cv2.waitKey(0)
cv2.imwrite('sign1/img6.jpg', approx_contour_img)
# cv2.imwrite('sign2/img6.jpg', approx_contour_img)

corners = [point[0] for point in approx_polygon]
for corner in corners:
    cv2.circle(approx_contour_img, tuple(corner), 8, (255, 150, 0), -1)
cv2.imshow('image', approx_contour_img)
cv2.waitKey(0)
cv2.imwrite('sign1/img7.jpg', approx_contour_img)
...
cv2.circle(img, upperLeft, 8, (0, 0, 255), -1)
cv2.circle(img, lowerLeft, 8, (0, 0, 255), -1)
cv2.circle(img, upperRight, 8, (0, 0, 255), -1)
cv2.circle(img, lowerRight, 8, (0, 0, 255), -1)
cv2.imshow('image', img)
cv2.waitKey(0)
cv2.imwrite('sign1/img8.jpg', img)
...
cv2.waitKey(0)
cv2.imwrite('sign1/img9.jpg', cropped_img)
