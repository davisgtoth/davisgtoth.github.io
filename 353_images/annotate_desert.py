...
cv2.waitKey(0)
# cv2.imwrite('desert1/img1.jpg', img)
...
cv2.waitKey(0)
# cv2.imwrite('desert1/img2.jpg', mask)
...
cv2.waitKey(0)
# cv2.imwrite('desert1/img3.jpg', contour_colour_img)
...
cv2.waitKey(0)
# cv2.imwrite('desert1/img4.jpg', filtered_contour_img)
...
cv2.waitKey(0)
# cv2.imwrite('desert1/img5.jpg', approx_contour_img)
...
cv2.waitKey(0)
# cv2.imwrite('desert1/img6.jpg', pid_image)
...
cv2.line(pid_image, (0, height - buffer), (width, height - buffer), (0, 255, 0), 3)
cv2.circle(pid_image, (left, height - buffer), 8, (0, 0, 255), -1)
cv2.circle(pid_image, (right, height - buffer), 8, (0, 0, 255), -1)
cv2.imshow('image', pid_image)
cv2.waitKey(0)
# cv2.imwrite('desert1/img7.jpg', pid_image)
...
cv2.line(img, (width // 2, 0), (width // 2, height), (0, 255, 0), 3)
cv2.line(img, (centre, height - buffer), (width // 2, height - buffer), (255, 0, 0), 3)
cv2.putText(img, "error", (width // 2 + 10, height - buffer - 15), cv2.FONT_HERSHEY_SIMPLEX, 1.4, (255, 0, 0), 3)
cv2.imshow('image', img)
cv2.waitKey(0)
# cv2.imwrite('desert1/img8.jpg', img)
